...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Aplikasi Klinik Medika">
    <meta name="generator" content="Kelompok 2 Kelas 12.3B.03">
    <title>Login | Klinik Medika</title>
    ...
    <link rel="icon" href="<?= base_url(); ?>assets/icon.jpg">
  ...
  <img class="mb-4" src="<?= base_url(); ?>assets/icon.jpg" alt="" width="72" height="72">
  ...
  <p class="mt-5 mb-3 text-muted">&copy; 2021. Kelompok 2 - Kelas 12.3B.03</p>
</form>
</body>
</html>
